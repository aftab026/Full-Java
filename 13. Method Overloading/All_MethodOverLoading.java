// Q:- 01. Write two methods with the same name but different number of parameters of same type
...
public class All_MethodOverLoading {
    int num1;
    int num2;
    int rollNo;
    String name;

    // 01.Two methods with the same name but different number of parameters of same
    // type
    ...
    // 02.Two methods with the same name but different number of parameters of
    // different data type
    ...
    // 04.Two methods with the same name and same number of parameters of different
    // type
    ...
    public static void main(String[] args) {
        All_MethodOverLoading mo = new All_MethodOverLoading();
...
/*
 * NOTE :
 * 03. We can not define more than one method with the same name, Order, and
 * type of the arguments.
 * It would be a compiler error.
 * 
 * 05. The compiler does not consider the return type while differentiating the
 * overloaded method.
 * But you cannot declare two methods with the same signature and different
 * return types.
