// q:- 2. Call the constructors(both default and argument constructors) of super class from a child
//   class
...
public class CallSuper {
    public static void main(String[] args) {
        ...
        new ChildClass_02();
        new ChildClass_02(553);
        new ChildClass_02("Aftab", "CSE", "PU", "VADODARA");
    }
}
